...
module.exports = async (interaction, client) => {
    ...
    try {
        ...
        if (characterData) {
            ...
            await privateChannel.send(`<@${interaction.user.id}> has denied your character submission **${characterData.name}** was denied for the following reason: ${reason}. Please adjust and resubmit.`);
            ...
            const confirmButton = new ActionRowBuilder()
                ...
                const confirmButton2 = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder()
            ...
            await interaction.editReply({ content: "The denial process has been completed.", ephemeral: true });
        } else {
            await interaction.editReply({ content: "No character data found to deny.", ephemeral: true });
        }
    } catch (error) {
