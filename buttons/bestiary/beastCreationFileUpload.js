...
module.exports = async (interaction, _client) => {
  ...
  const modalPayload = {
    custom_id: 'beastFileUploadModal',
    title: 'Upload Beast Data',
    components: [
      {
        type: 18, // Label
        label: 'Beast Data File',
        description:
          'Upload JSON, TXT, PDF, or DOCX (required: name, habitat, appearance, abilities, significance)',
        component: {
          type: 19, // File Upload
          custom_id: 'beast_file',
          required: true,
          min_values: 1,
          max_values: 1,
        },
