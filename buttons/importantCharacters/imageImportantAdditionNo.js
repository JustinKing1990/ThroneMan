...
module.exports = async (interaction, _client) => {
  ...
  // Get character name - either from custom_id with underscore (new format: imageImportantAdditionNo_name)
  // or need to fetch from database (old format: imageImportantAdditionNo)
