/**
 * Shows the user a choice between manual entry or file upload for character creation
 */
...
module.exports = async (interaction, _client) => {
  const embed = new EmbedBuilder()
    .setColor('#0099ff')
    .setTitle('Character Creation Method')
  ...
  const row = new ActionRowBuilder().addComponents(
    new ButtonBuilder()
      .setCustomId('characterCreationManual')
      .setLabel('Manual Entry')
      .setStyle(ButtonStyle.Primary)
      .setEmoji('📝'),
    new ButtonBuilder()
      .setCustomId('characterCreationFileUpload')
