module.exports = {
    ...
    execute(member) {
        ...
        welcomeChannel.send(`@${member.user.username} Hey welcome to Alawal we are all glad to see you here. To start your adventures in our world go to <#${ruleChannelID}> .
